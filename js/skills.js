...
function move(e) {
  // MOVE 3D ABHASH WHEN MOUSE MOVES
  ...
  //   MOVE SKILLS WITH MOUSE
  skillsFrame = Math.floor(e.clientX * -1.3);
  gsap.to(skillsBox, {
    x: skillsFrame,
    snap: "x",
    ease: `none`,
  ...
  // CHANGE SIZE OF SKILLS FOR 3D EFFECT
  if (cursorpos < 0.25) {
...
setTimeout(() => {
  if (showGuide) {
    helpingArrow.style.display = "inline-block";
    helpingArrow.style.animation = "twinkle 1s alternate ease-in-out infinite";
  }
}, 10000);
